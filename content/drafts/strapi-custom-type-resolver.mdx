---
title: Make a custom type resolver for strapi
date: 2020-11-15
---
...
- [Why use Gatsby for your blog?](#why-use-gatsby-for-your-blog)
...
In this advanced tutorial, you’ll learn how to make a custom type resolver for strapi

## Why use a custom type resolver?

Benefits of using a custom type resolver include the following:

- implement custom logic for related fields query that strapi provides
- add a custom/calculated field without adding it to strapi's data model

## Prerequisites

- Since this is a more advanced tutorial, building a site with Strapi before will likely make this tutorial less time-consuming ([see the main tutorial here](/tutorial/))

# Setting up a Strapi site

Create a new Strapi project by running the `yarn create strapi-app` command in the terminal and change directories into the new project you just started:
  ...
  plugins: [
    ...
    "gatsby-plugin-sharp",
    {
      ...
      options: {
        ...
        headers: {
          Authorization: `bearer ${process.env.GITHUB_TOKEN}`, // change this to GATSBY_GITHUB_TOKEN
        },
        fetchOptions: {},
      },
    },
...
Github Actions are blah blah [github-actions](https://github.com/features/actions)

### Getting your GitHub deployment key & Setting up secrets as env
