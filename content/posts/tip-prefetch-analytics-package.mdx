...
Open the root site directory in a text editor and navigate to `config.js` and replace the googleAnalyticsID in `config.js` with your own. Your `config.js` should look like the following code example:
...
Right click on the page and inspect it. Go to audit and generate a report. One of the performance issues that will be the following.
