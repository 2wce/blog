...
In this advanced tutorial, you’ll learn how to fix a issue in Gatsby that can be highlighted when you use google analytics and audit your site with [Lighthouse](https://stripe.com).
...
Right click on the page and inspect it. Go to audit and generate a report. One of the performance issues that will be highlightted will be like the following.
